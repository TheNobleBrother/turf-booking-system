...
export default function ClubhouseFilterSidebar({ filters, setFilters }: ClubhouseFilterSidebarProps) {
                ...
                <div className="space-y-2">
                    {[5, 4, 3, 2, 1].map((rating) => (
                        <button
                            ...
                            className={`w-full text-left px-3 py-2 rounded-lg transition-all ${filters.rating === rating
                    ...
                    <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded-lg transition-all ${filters.rating === 0
                                ? "bg-linear-to-r from-primary to-accent text-white font-semibold"
                                : "bg-secondary/30 text-foreground hover:bg-secondary/50"
                            }`}
                    >
