...
export default function ClubhouseDetailsPage() {
    ...
    const handleBookNow = () => {
        if (currentUser) {
            // Proceed to Payment
            // user request: "proceed with the payment process"
            // Since payment route isn't fully defined, we can mock redirection or push to a payment page if it exists.
            // I'll assume /payment or /checkout. If not, I'll log it.
            // Based on file structure, there is a `payment` dir.
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-12 container mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-end gap-6 animate-in slide-in-from-bottom-6 duration-700">
                        ...
                        <div className="flex gap-4">
                            <Button size="icon" variant="outline" className="h-12 w-12 bg-white/10 backdrop-blur-md border-white/20 text-white hover:bg-white hover:text-black rounded-full transition-all hover:scale-110">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        <div className="bg-card border border-border/50 rounded-3xl p-8 shadow-sm">
                            <h2 className="text-3xl font-black mb-6 tracking-tight">Overview</h2>
                            <p className="text-muted-foreground leading-relaxed text-xl font-light">
                                {club.description || "Experience world-class facilities and luxury amenities at this premier game center. Perfect for sports enthusiasts and leisure seekers alike."}
                            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-8 mt-8 pt-8 border-t border-border">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-muted-foreground text-sm font-medium">124 reviews</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-muted-foreground text-sm font-medium">Official Partner</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Amenities */}
                        <div className="bg-card border border-border/50 rounded-3xl p-8 shadow-sm">
                            <h2 className="text-3xl font-black mb-8 tracking-tight">Available Games & Amenities</h2>
                                ...
                                {club.amenities.map((amenity) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <span className="font-bold text-center text-sm md:text-base">{amenity}</span>
                                        </div>
                                    );
                                })}
                            </div>
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-card border border-border/50 rounded-3xl p-8 shadow-xl sticky top-28">
                            <div className="flex flex-col gap-1 mb-8">
                                <div className="text-muted-foreground font-medium text-lg">Price per hour</div>
                                <div className="text-5xl font-black text-primary tracking-tight">{club.price}</div>
                            </div>
                            ...
                            <div className="space-y-4 pt-8 border-t border-border bg-secondary/10 -mx-8 -mb-8 p-8 rounded-b-3xl">
                                ...
                                <div className="flex justify-between items-center text-sm">
                                    ...
                                    <span className="font-bold bg-background px-3 py-1 rounded-full shadow-xs">6 AM - 10 PM</span>
                                </div>
                                <div className="flex justify-between items-center text-sm">
                                    <span className="text-muted-foreground font-medium">Saturday - Sunday</span>
                                    <span className="font-bold bg-background px-3 py-1 rounded-full shadow-xs">5 AM - 11 PM</span>
                                </div>
                            </div>
                        </div>
                    </div>
